...
{% marginfigure "bar1" '../assets/claim-pred/bar1.jpeg' " Figure $4$: Barplots of qualitative variables." %}

{% marginfigure "bar2" '../assets/claim-pred/bar2.jpeg' " Figure $5$: Uglier Barplots." %}
